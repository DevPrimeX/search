...
**Click Bellow Button To Join Now.👇🏻**''', buttons=Button.url('🍿Updates Channel🍿', f'https://telegram.dog/{Config.UPDATES_CHANNEL_USERNAME}'))
        ...
        answer = f'**Join** [@{username}](https://telegram.dog/{username}) \n\n'
